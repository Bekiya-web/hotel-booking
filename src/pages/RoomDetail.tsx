          ...
          <div className="grid lg:grid-cols-[1fr_400px] gap-12">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-6 pb-8 border-b border-border mb-8">
                <span className="flex items-center gap-2 text-sm"><Star className="w-4 h-4 fill-yellow-500 text-yellow-500" /> {room.rating} ({room.reviews} reviews)</span>
              ...
              <div className="prose prose-invert max-w-none mb-10">
                ...
                <p className="text-foreground/80 leading-relaxed text-lg">{room.longDescription}</p>
              </div>
            ...
            <aside className="lg:sticky lg:top-28 self-start">
              <div className="bg-card border border-border rounded-md shadow-elegant p-6">
                ...
                <Button onClick={() => navigate(`/checkout/${room.id}`)} variant="hero" size="xl" className="w-full mb-3">
                  Book this room
                </Button>
