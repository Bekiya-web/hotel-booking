        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-foreground/80">
            <li className="flex items-start gap-2">
              <MapPin className="w-4 h-4 mt-0.5 text-yellow-600" /> 
              {hotelInfo?.address || "Addis Ababa, Ethiopia"}
            </li>
            <li className="flex items-start gap-2">
              <Phone className="w-4 h-4 mt-0.5 text-yellow-600" /> 
              {hotelInfo?.phone || "+251 911 234 567"}
            </li>
            <li className="flex items-start gap-2">
              <Mail className="w-4 h-4 mt-0.5 text-yellow-600" /> 
              {hotelInfo?.email || "yilmahotel@gmail.com"}
            </li>
          </ul>
        </div>
      </div>
